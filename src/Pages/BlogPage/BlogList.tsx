...
const blogs = [
  {
    ...
    image:
      "https://theambedkarianchronicle.in/images/spirituality-dalit-women-and-buddha.jpg",
  ...
  },
  {
    ...
    image:
      "https://theambedkarianchronicle.in/images/remembering-babashab-ambedkar-unfinished-task-burying-manu.jpg",
  ...
  },
  {
    ...
    image:
      "https://theambedkarianchronicle.in/images/escaping-sugarcane-fields.jpg",
  ...
  },
  {
    ...
    image:
      "https://theambedkarianchronicle.in/images/phoolan-devi-prison-years.jpg",
    author: "Ritesh Jyoti",
    date: "9/2/2026",
...
const BlogList = ({ showHeader }: { showHeader: boolean }) => {
  return (
        ...
        {blogs.map((blog) => (
          ...
          >
            ...
            <div className="p-5 flex flex-col h-[260px]">
              <h3 className="text-2xl font-bold text-gray-900 line-clamp-2 mb-3">
                {blog.title}
              </h3>
